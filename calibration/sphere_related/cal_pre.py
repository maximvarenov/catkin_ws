...
filename = "/media/ruixuan/Volume/ruixuan/Pictures/icar/sphere2/cal1.txt"
file=open(filename)
lines=file.readlines()
path= '/media/ruixuan/Volume/ruixuan/Pictures/icar/sphere2/cal1/'
