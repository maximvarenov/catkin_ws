...
def calculation():  
    ...
    for i in range(numPoints): 
        vi = data[i][1] -217   #-217 - data[i][1]   # height - cv -x -
        ui = data[i][0] -33   # width - cv -y-
    ...
    np.save("/media/ruixuan/Volume/ruixuan/Pictures/icar/sphere2/calibration1.npy",mat)
    np.save("/media/ruixuan/Volume/ruixuan/Pictures/icar/sphere2/scale1.npy",s)
