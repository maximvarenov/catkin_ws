...
filename = "/media/ruixuan/Volume/ruixuan/Pictures/auto_cali_sphere8/cal3.txt"
file=open(filename)
lines=file.readlines()
path= '/media/ruixuan/Volume/ruixuan/Pictures/auto_cali_sphere8/cal_3/'
...
for i,line in zip(sorted_file,lines):  
    ...
    if count % 10 ==0:
        ...
        circle_draw=cv2.circle(canny,(int(xc_2), int(yc_2)),int(R_2),(255,255,255),-1)
        
        cv2.imwrite('auto'+str(count)+'.png', circle_draw)
