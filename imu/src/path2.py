...
################################
                roll2 = math.atan2(2*(pose_topic.pose.pose.orientation.w* pose_topic.pose.pose.orientation.x+pose_topic.pose.pose.orientation.y*pose_topic.pose.pose.orientation.z),1-2*( pose_topic.pose.pose.orientation.x* pose_topic.pose.pose.orientation.x+pose_topic.pose.pose.orientation.y*pose_topic.pose.pose.orientation.y))*180
                pitch2 = math.asin(2*(pose_topic.pose.pose.orientation.w*pose_topic.pose.pose.orientation.y-pose_topic.pose.pose.orientation.z*pose_topic.pose.pose.orientation.x))*180
                yaw2 = math.atan2(2*(pose_topic.pose.pose.orientation.w * pose_topic.pose.pose.orientation.z+ pose_topic.pose.pose.orientation.x*pose_topic.pose.pose.orientation.y),1-2*(pose_topic.pose.pose.orientation.z*pose_topic.pose.pose.orientation.z+pose_topic.pose.pose.orientation.y*pose_topic.pose.pose.orientation.y))*180
